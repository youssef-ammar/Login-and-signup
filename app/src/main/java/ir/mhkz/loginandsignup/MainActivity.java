...
public class MainActivity extends AppCompatActivity {
    ...
    Button login, signUp, reg_register,profile;
...
//        AlertDialog.Builder dialog = new AlertDialog.Builder(this);
        ...
        dialog.setContentView(R.layout.profile); // Replace with the layout you want to use
        dialog.setTitle("Profile"); // Optional: Set a title for your dialog
...
//        pr_username = dialogView.findViewById(R.id.pr_username);
//        pr_password = dialogView.findViewById(R.id.pr_password);
